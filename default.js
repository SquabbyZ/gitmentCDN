var Gitment = /******/ (function(modules) {
  ...
  /******/ [
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var LS_ACCESS_TOKEN_KEY = (exports.LS_ACCESS_TOKEN_KEY =
        "gitment-comments-token");
      var LS_USER_KEY = (exports.LS_USER_KEY = "gitment-user-info");

      var NOT_INITIALIZED_ERROR = (exports.NOT_INITIALIZED_ERROR = new Error(
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      /* WEBPACK VAR INJECTION */ (function(global) {
        ...
        function reaction(expression, effect, arg3) {
          ...
          var opts;
          if (
            (typeof arg3 === "undefined" ? "undefined" : _typeof(arg3)) ===
            "object"
          ) {
            opts = arg3;
          } else {
        ...
        var computed = function computed(arg1, arg2, arg3) {
          ...
          var opts =
            (typeof arg2 === "undefined" ? "undefined" : _typeof(arg2)) ===
            "object"
              ? arg2
              : {};
        ...
        function extendObservableHelper(target, defaultEnhancer, properties) {
          ...
          properties.forEach(function(propSet) {
            invariant(
              (typeof propSet === "undefined"
                ? "undefined"
                : _typeof(propSet)) === "object",
              getMessage("m017")
            );
        ...
        function invariantObservers(observable) {
          ...
          for (var i = 0; i < l; i++) {
            ...
            if (i) {
              invariant(
                map[id] === i,
                "INTERNAL ERROR maps derivation.__mapid to index in list"
              );
            } else {
              invariant(
                !(id in map),
                "INTERNAL ERROR observer on index 0 shouldnt be held in map."
              );
            }
          }
          invariant(
        ...
        var ObservableArray = (function(_super) {
          ...
          ObservableArray.prototype.toLocaleString = function() {
            this.$mobx.atom.reportObserved();
            return Array.prototype.toLocaleString.apply(
              this.$mobx.values,
              arguments
            );
          };
        ...
        var messages = {
          ...
          m031:
            "Computed values are not allowed to not cause side effects by changing observables that are already being observed. Tried to modify: ",
          m032:
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      function renderEditor(_ref3, instance) {
        ...
        container.innerHTML =
          ...
          (user.login
            ? '<a class="gitment-editor-avatar" href="' +
              ...
              '"/>\n          </a>'
            : user.isLoggingIn
            ? '<div class="gitment-editor-avatar">' + _icons.spinner + "</div>"
            : '<a class="gitment-editor-avatar" href="' +
              instance.loginLink +
        ...
        var previewField = container.querySelector(
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      function extendRenderer(instance, renderer) {
        instance[renderer] = function(container) {
          ...
          var render =
            instance.theme[renderer] || instance.defaultTheme[renderer];
            ...
            value: function loadMeta() {
              ...
              return _utils.http
                ...
                .then(function(issues) {
                  if (!issues.length)
                    return Promise.reject(_constants.NOT_INITIALIZED_ERROR);
